...
export const assuranceRoadmap = [
  ...
  { id: "P1-REPO-SENSITIVITY", priority: "P1", area: "Repositorios", action: "Sensibilidad y política proporcional", state: "IMPLEMENTED", exit: "Catálogo con owner, datos, exposición y gate mínimo; 16 registros contractuales." },
  { id: "P1-IDENTITY", priority: "P1", area: "Identidad", action: "Scopes, owner isolation y autorización", state: "IMPLEMENTED", exit: "Negative tests y separación de aprobadores completos." },
  { id: "P1-OBSERVABILITY", priority: "P1", area: "Observabilidad", action: "SLOs, trazas y alertas runtime", state: "IMPLEMENTED", exit: "Métrica verificable y fallo reproducible; observabilidad runtime de conectores y alertas por error budget/p95." },
